        ...
        {page === 'about' ? (
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1 min-w-0 space-y-4">
              ...
              {currentTicker && (
                <div className="flex items-center justify-between animate-fade-in neo-card-flat p-3 mb-4">
              ...
              {/* Welcome state */}
              {!currentTicker && !isLoadingChart && (
                <div className="neo-card p-12 flex flex-col items-center gap-6 text-center animate-fade-in bg-neo-lime">
                  <div className="w-20 h-20 rounded-full bg-white border-4 border-black flex items-center justify-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-y-1 hover:translate-x-1 hover:shadow-none transition-all">
